...
static size_t asgeojson_line_size(const LWLINE *line, const char *srs, GBOX *bbox, int precision) {
	int size;
...
static size_t asgeojson_line_buf(const LWLINE *line, const char *srs, char *output, GBOX *bbox, int precision) {
	char *ptr = output;
...
static size_t asgeojson_poly_size(const LWPOLY *poly, const char *srs, GBOX *bbox, int precision) {
	size_t size;
	uint32_t i;
...
static size_t asgeojson_poly_buf(const LWPOLY *poly, const char *srs, char *output, GBOX *bbox, int precision) {
	uint32_t i;
...
static size_t asgeojson_multipoint_size(const LWMPOINT *mpoint, const char *srs, GBOX *bbox, int precision) {
	LWPOINT *point;
	int size;
	uint32_t i;
...
static size_t asgeojson_multipoint_buf(const LWMPOINT *mpoint, const char *srs, char *output, GBOX *bbox,
                                       int precision) {
	LWPOINT *point;
	uint32_t i;
	char *ptr = output;
...
static size_t asgeojson_multiline_size(const LWMLINE *mline, const char *srs, GBOX *bbox, int precision) {
	LWLINE *line;
	int size;
	uint32_t i;
...
static size_t asgeojson_multiline_buf(const LWMLINE *mline, const char *srs, char *output, GBOX *bbox, int precision) {
	LWLINE *line;
	uint32_t i;
	char *ptr = output;
...
static size_t asgeojson_multipolygon_size(const LWMPOLY *mpoly, const char *srs, GBOX *bbox, int precision) {
	LWPOLY *poly;
	int size;
	uint32_t i, j;
...
static size_t asgeojson_multipolygon_buf(const LWMPOLY *mpoly, const char *srs, char *output, GBOX *bbox,
                                         int precision) {
	LWPOLY *poly;
	uint32_t i, j;
	char *ptr = output;
...
static size_t asgeojson_collection_size(const LWCOLLECTION *col, const char *srs, GBOX *bbox, int precision) {
	uint32_t i;
	size_t size;
	LWGEOM *subgeom;
...
static size_t asgeojson_collection_buf(const LWCOLLECTION *col, const char *srs, char *output, GBOX *bbox,
                                       int precision) {
	uint32_t i;
	char *ptr = output;
	LWGEOM *subgeom;
