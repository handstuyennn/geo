...
// public:
//
/*static*/ geom::Location RayCrossingCounter::locatePointInRing(const geom::CoordinateXY &point,
...
void RayCrossingCounter::countSegment(const geom::CoordinateXY &p1, const geom::CoordinateXY &p2) {
...
geom::Location RayCrossingCounter::getLocation() const {
	if (isPointOnSegment) {
