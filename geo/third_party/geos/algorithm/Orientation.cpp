...
int Orientation::index(const geom::CoordinateXY &p1, const geom::CoordinateXY &p2, const geom::CoordinateXY &q) {
	return CGAlgorithmsDD::orientationIndex(p1, p2, q);
}

/* public static */
bool Orientation::isCCW(const geom::CoordinateSequence *ring) {
...
/* public static */
bool Orientation::isCCWArea(const geom::CoordinateSequence *ring) {
