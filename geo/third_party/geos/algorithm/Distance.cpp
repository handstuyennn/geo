...
/*public static*/
double Distance::pointToSegment(const geom::CoordinateXY &p, const geom::CoordinateXY &A, const geom::CoordinateXY &B) {
...
/*public static*/
double Distance::segmentToSegment(const geom::CoordinateXY &A, const geom::CoordinateXY &B, const geom::CoordinateXY &C,
	...
	*/
	...
	if (noIntersection) {
		...
		return std::min(pointToSegment(A, C, D),
		                std::min(pointToSegment(B, C, D), std::min(pointToSegment(C, A, B), pointToSegment(D, A, B))));
	}
...
/*public static*/
double Distance::pointToSegmentString(const geom::CoordinateXY &p, const geom::CoordinateSequence *seq) {
	if (seq->isEmpty()) {
		throw util::IllegalArgumentException("Line array must contain at least one vertex");
	}
