 ...
 */
geom::Location SimplePointInAreaLocator::locate(const CoordinateXY &p, const Geometry *geom) {
	return locateInGeometry(p, geom);
}

bool SimplePointInAreaLocator::isContained(const CoordinateXY &p, const Geometry *geom) {
	return Location::EXTERIOR != locate(p, geom);
}

geom::Location SimplePointInAreaLocator::locateInGeometry(const CoordinateXY &p, const Geometry *geom) {
	/*
...
geom::Location SimplePointInAreaLocator::locatePointInPolygon(const CoordinateXY &p, const Polygon *poly) {
	if (poly->isEmpty()) {
		return Location::EXTERIOR;
	}
