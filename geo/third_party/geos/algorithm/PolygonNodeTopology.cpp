...
/* public static */
bool PolygonNodeTopology::isCrossing(const CoordinateXY *nodePt, const CoordinateXY *a0, const CoordinateXY *a1,
...
/* public static */
bool PolygonNodeTopology::isInteriorSegment(const CoordinateXY *nodePt, const CoordinateXY *a0, const CoordinateXY *a1,
	...
	bool isInterior = (bBetween && isInteriorBetween) || (!bBetween && !isInteriorBetween);
	return isInterior;
}

/* private static */
bool PolygonNodeTopology::isAngleGreater(const CoordinateXY *origin, const CoordinateXY *p, const CoordinateXY *q) {
...
/* private static */
bool PolygonNodeTopology::isBetween(const CoordinateXY *origin, const CoordinateXY *p, const CoordinateXY *e0,
...
/* private static */
int PolygonNodeTopology::quadrant(const CoordinateXY *origin, const CoordinateXY *p) {
