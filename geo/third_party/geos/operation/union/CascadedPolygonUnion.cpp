...
std::unique_ptr<geom::Geometry> CascadedPolygonUnion::restrictToPolygons(std::unique_ptr<geom::Geometry> g) {
	...
	if (coll) {
		...
		components.erase(std::remove_if(components.begin(), components.end(),
		                                [](const std::unique_ptr<Geometry> &cmp) { return !cmp->isPolygonal(); }),
		                 components.end());
...
// ////////////////////////////////////////////////////////////////////////////
std::unique_ptr<geom::Geometry> CascadedPolygonUnion::Union(std::vector<geom::Polygon *> *polys) {
...
std::unique_ptr<geom::Geometry> CascadedPolygonUnion::Union(const geom::MultiPolygon *multipoly) {
...
std::unique_ptr<geom::Geometry> CascadedPolygonUnion::Union() {
	if (inputPolys->empty()) {
		return nullptr;
	}
...
std::unique_ptr<geom::Geometry> CascadedPolygonUnion::binaryUnion(const std::vector<const geom::Geometry *> &geoms,
...
std::unique_ptr<geom::Geometry> CascadedPolygonUnion::unionSafe(const geom::Geometry *g0,
...
std::unique_ptr<geom::Geometry> CascadedPolygonUnion::unionSafe(std::unique_ptr<geom::Geometry> &&g0,
...
std::unique_ptr<geom::Geometry> CascadedPolygonUnion::unionActual(const geom::Geometry *g0,
                                                                  const geom::Geometry *g1) const {
...
std::unique_ptr<geom::Geometry> CascadedPolygonUnion::unionActual(std::unique_ptr<geom::Geometry> &&g0,
...
std::unique_ptr<geom::Geometry> ClassicUnionStrategy::Union(const geom::Geometry *g0, const geom::Geometry *g1) {
...
bool ClassicUnionStrategy::isFloatingPrecision() const {
	return true;
}

/*private*/
std::unique_ptr<geom::Geometry> ClassicUnionStrategy::unionPolygonsByBuffer(const geom::Geometry *g0,
