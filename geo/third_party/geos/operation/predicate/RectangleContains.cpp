...
/*private*/
bool RectangleContains::isContainedInBoundary(const Geometry &geom) {
...
/*private*/
bool RectangleContains::isLineStringContainedInBoundary(const LineString &line) {
...
/*private*/
bool RectangleContains::isLineSegmentContainedInBoundary(const Coordinate &p0, const Coordinate &p1) {
	if (p0.equals2D(p1)) {
...
/*private*/
bool RectangleContains::isPointContainedInBoundary(const Point &point) {
	return isPointContainedInBoundary(*(point.getCoordinate()));
}

/*private*/
bool RectangleContains::isPointContainedInBoundary(const Coordinate &pt) {
	/**
...
bool RectangleContains::contains(const Geometry &geom) {
