...
bool SegmentIntersectionTester::hasIntersectionWithLineStrings(const LineString &line,
...
bool SegmentIntersectionTester::hasIntersection(const LineString &line, const LineString &testLine) {
...
bool SegmentIntersectionTester::hasIntersectionWithEnvelopeFilter(const LineString &line, const LineString &testLine) {
	typedef std::size_t size_type;
