...
/*public*/
std::vector<std::unique_ptr<Point>> IntersectionPointBuilder::getPoints() {
	addResultPoints();
...
/*private*/
void IntersectionPointBuilder::addResultPoints() {
...
/*private*/
bool IntersectionPointBuilder::isResultPoint(OverlayEdge *nodeEdge) const {
...
/*private*/
bool IntersectionPointBuilder::isEdgeOf(const OverlayLabel *label, uint8_t i) const {
