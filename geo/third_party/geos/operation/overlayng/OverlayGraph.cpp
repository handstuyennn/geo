...
#include <geos/operation/overlayng/Edge.hpp>
...
/*public*/
std::vector<OverlayEdge *> &OverlayGraph::getEdges() {
	return edges;
}

/*public*/
std::vector<OverlayEdge *> OverlayGraph::getNodeEdges() {
...
/*public*/
OverlayEdge *OverlayGraph::getNodeEdge(const Coordinate &nodePt) const {
...
/*public*/
std::vector<OverlayEdge *> OverlayGraph::getResultAreaEdges() {
...
/*public*/
OverlayEdge *OverlayGraph::addEdge(Edge *edge) {
...
/*private*/
OverlayEdge *OverlayGraph::createEdgePair(const CoordinateSequence *pts, OverlayLabel *lbl) {
...
/*private*/
OverlayEdge *OverlayGraph::createOverlayEdge(const CoordinateSequence *pts, OverlayLabel *lbl, bool direction) {
	Coordinate origin;
	Coordinate dirPt;
	if (direction) {
		origin = pts->getAt(0);
...
/*public*/
OverlayLabel *OverlayGraph::createOverlayLabel(const Edge *edge) {
...
/*private*/
void OverlayGraph::insert(OverlayEdge *e) {
	edges.push_back(e);
