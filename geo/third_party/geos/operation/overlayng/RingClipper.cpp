...
#include <geos/operation/overlayng/RingClipper.hpp>
...
/*public*/
std::unique_ptr<CoordinateArraySequence> RingClipper::clip(const CoordinateSequence *cs) const {
...
/*private*/
std::unique_ptr<CoordinateArraySequence> RingClipper::clipToBoxEdge(const CoordinateSequence *pts, int edgeIndex,
                                                                    bool closeRing) const {
...
/*private*/
void RingClipper::intersection(const Coordinate &a, const Coordinate &b, int edgeIndex, Coordinate &rsltPt) const {
	switch (edgeIndex) {
	case BOX_BOTTOM:
...
/*private*/
double RingClipper::intersectionLineY(const Coordinate &a, const Coordinate &b, double y) const {
...
/*private*/
double RingClipper::intersectionLineX(const Coordinate &a, const Coordinate &b, double x) const {
...
/*private*/
bool RingClipper::isInsideEdge(const Coordinate &p, int edgeIndex) const {
	if (clipEnv.isNull()) {
		return false;
	}
