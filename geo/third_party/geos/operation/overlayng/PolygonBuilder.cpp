...
/*public*/
std::vector<std::unique_ptr<Polygon>> PolygonBuilder::getPolygons() const {
	return computePolygons(shellList);
}

/*public*/
std::vector<OverlayEdgeRing *> PolygonBuilder::getShellRings() const {
	return shellList;
}
...
/*private*/
void PolygonBuilder::buildRings(const std::vector<OverlayEdge *> &resultAreaEdges) {
...
/*private*/
void PolygonBuilder::linkResultAreaEdgesMax(const std::vector<OverlayEdge *> &resultEdges) {
...
/*private*/
void PolygonBuilder::buildMinimalRings(const std::vector<std::unique_ptr<MaximalEdgeRing>> &maxRings) {
...
/*private*/
void PolygonBuilder::assignShellsAndHoles(const std::vector<OverlayEdgeRing *> &minRings) {
	/**
...
/*private*/
OverlayEdgeRing *PolygonBuilder::findSingleShell(const std::vector<OverlayEdgeRing *> &edgeRings) {
...
/*private*/
void PolygonBuilder::assignHoles(OverlayEdgeRing *shell, const std::vector<OverlayEdgeRing *> &edgeRings) {
	for (auto er : edgeRings) {
		if (er->isHole()) {
			er->setShell(shell);
		}
...
/*private*/
void PolygonBuilder::placeFreeHoles(const std::vector<OverlayEdgeRing *> &shells,
                                    const std::vector<OverlayEdgeRing *> &freeHoles) const {
