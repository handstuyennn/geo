...
RobustClipEnvelopeComputer::RobustClipEnvelopeComputer(const Envelope *p_targetEnv)
    : targetEnv(p_targetEnv), clipEnv(*p_targetEnv) {
}

/*public static*/
Envelope RobustClipEnvelopeComputer::getEnvelope(const Geometry *a, const Geometry *b, const Envelope *targetEnv) {
...
/*public*/
Envelope RobustClipEnvelopeComputer::getEnvelope() {
	return clipEnv;
}

/*public*/
void RobustClipEnvelopeComputer::add(const Geometry *g) {
...
/*private*/
void RobustClipEnvelopeComputer::addCollection(const GeometryCollection *gc) {
...
/*private*/
void RobustClipEnvelopeComputer::addPolygon(const Polygon *poly) {
 ...
 */
/*private*/
void RobustClipEnvelopeComputer::addPolygonRing(const LinearRing *ring) {
...
/*private*/
void RobustClipEnvelopeComputer::addSegment(const Coordinate &p1, const Coordinate &p2) {
...
/*private*/
bool RobustClipEnvelopeComputer::intersectsSegment(const Envelope *env, const Coordinate &p1, const Coordinate &p2) {
	/**
