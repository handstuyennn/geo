...
InputGeometry::InputGeometry(const Geometry *geomA, const Geometry *geomB)
    : geom {{geomA, geomB}}, isCollapsed {{false, false}} {
}

/*public*/
bool InputGeometry::isSingle() const {
	return geom[1] == nullptr;
}

/*public*/
int InputGeometry::getDimension(uint8_t index) const {
...
/*public*/
const Geometry *InputGeometry::getGeometry(uint8_t geomIndex) const {
	return geom[geomIndex];
}

/*public*/
const Envelope *InputGeometry::getEnvelope(uint8_t geomIndex) const {
	return geom[geomIndex]->getEnvelopeInternal();
}

/*public*/
bool InputGeometry::isEmpty(uint8_t geomIndex) const {
	return geom[geomIndex]->isEmpty();
}

/*public*/
bool InputGeometry::isArea(uint8_t geomIndex) const {
...
/*public*/
int InputGeometry::getAreaIndex() const {
	if (getDimension(0) == 2)
		return 0;
	if (getDimension(1) == 2)
		return 1;
...
/*public*/
bool InputGeometry::isLine(uint8_t geomIndex) const {
	return getDimension(geomIndex) == 1;
}

/*public*/
bool InputGeometry::isAllPoints() const {
	return getDimension(0) == 0 && geom[1] != nullptr && getDimension(1) == 0;
}

/*public*/
bool InputGeometry::hasPoints() const {
 ...
 */
/*public*/
bool InputGeometry::hasEdges(uint8_t geomIndex) const {
 ...
 */
/*public*/
Location InputGeometry::locatePointInArea(uint8_t geomIndex, const Coordinate &pt) {
...
/*private*/
PointOnGeometryLocator *InputGeometry::getLocator(uint8_t geomIndex) {
	if (geomIndex == 0) {
...
/*public*/
void InputGeometry::setCollapsed(uint8_t geomIndex, bool isGeomCollapsed) {
