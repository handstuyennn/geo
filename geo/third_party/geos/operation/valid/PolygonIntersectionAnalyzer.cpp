...
#include <geos/util/IllegalStateException.hpp>
...
/* private */
bool PolygonIntersectionAnalyzer::addDoubleTouch(const SegmentString *ss0, const SegmentString *ss1,
                                                 const CoordinateXY &intPt) {
	return PolygonRing::addTouch(const_cast<PolygonRing *>(static_cast<const PolygonRing *>(ss0->getData())),
	                             const_cast<PolygonRing *>(static_cast<const PolygonRing *>(ss1->getData())), intPt);
}

/* private */
void PolygonIntersectionAnalyzer::addSelfTouch(const SegmentString *ss, const CoordinateXY &intPt,
...
/* public */
void PolygonIntersectionAnalyzer::processIntersections(SegmentString *ss0, std::size_t segIndex0, SegmentString *ss1,
...
/* private */
int PolygonIntersectionAnalyzer::findInvalidIntersection(const SegmentString *ss0, std::size_t segIndex0,
...
/* private */
const CoordinateXY &PolygonIntersectionAnalyzer::prevCoordinateInRing(const SegmentString *ringSS,
                                                                      std::size_t segIndex) const {
...
/* private */
bool PolygonIntersectionAnalyzer::isAdjacentInRing(const SegmentString *ringSS, std::size_t segIndex0,
                                                   std::size_t segIndex1) const {
	std::size_t delta = segIndex0 > segIndex1 ? segIndex0 - segIndex1 : segIndex1 - segIndex0;
