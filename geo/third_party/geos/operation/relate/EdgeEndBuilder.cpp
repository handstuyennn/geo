...
std::vector<std::unique_ptr<EdgeEnd>> EdgeEndBuilder::computeEdgeEnds(std::vector<Edge *> *edges) {
 ...
 */
void EdgeEndBuilder::computeEdgeEnds(Edge *edge, std::vector<std::unique_ptr<EdgeEnd>> &l) {
 ...
 */
void EdgeEndBuilder::createEdgeEndForPrev(Edge *edge, std::vector<std::unique_ptr<EdgeEnd>> &l,
 ...
 */
void EdgeEndBuilder::createEdgeEndForNext(Edge *edge, std::vector<std::unique_ptr<EdgeEnd>> &l,
