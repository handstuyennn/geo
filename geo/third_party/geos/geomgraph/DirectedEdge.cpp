...
DirectedEdge::DirectedEdge(Edge *newEdge, bool newIsForward)
    : EdgeEnd(newEdge), isForwardVar(newIsForward), isInResultVar(false), isVisitedVar(false), sym(nullptr),
      next(nullptr), nextMin(nullptr), edgeRing(nullptr), minEdgeRing(nullptr) {
	depth[0] = 0;
	depth[1] = -999;
	depth[2] = -999;
