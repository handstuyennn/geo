 ...
 */
bool SegmentIntersector::isTrivialIntersection(Edge *e0, std::size_t segIndex0, Edge *e1, std::size_t segIndex1) {
	//	if (e0->equals(e1))
	if (e0 == e1) {
 ...
 */
void SegmentIntersector::addIntersections(Edge *e0, std::size_t segIndex0, Edge *e1, std::size_t segIndex1) {
...
/*private*/
bool SegmentIntersector::isBoundaryPoint(LineIntersector *p_li, std::vector<Node *> *tstBdyNodes) {
	if (!tstBdyNodes) {
		return false;
	}
