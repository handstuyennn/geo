...
void SimpleMCSweepLineIntersector::computeIntersections(std::vector<Edge *> *edges, SegmentIntersector *si,
...
void SimpleMCSweepLineIntersector::computeIntersections(std::vector<Edge *> *edges0, std::vector<Edge *> *edges1,
...
void SimpleMCSweepLineIntersector::add(std::vector<Edge *> *edges) {
...
void SimpleMCSweepLineIntersector::add(std::vector<Edge *> *edges, void *edgeSet) {
	for (std::size_t i = 0; i < edges->size(); ++i) {
		Edge *edge = (*edges)[i];
		add(edge, edgeSet);
	}
...
void SimpleMCSweepLineIntersector::processOverlaps(std::size_t start, std::size_t end, SweepLineEvent *ev0,
                                                   SegmentIntersector *si) {
