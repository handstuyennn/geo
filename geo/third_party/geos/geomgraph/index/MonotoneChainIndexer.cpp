...
void MonotoneChainIndexer::getChainStartIndices(const CoordinateSequence *pts, std::vector<size_t> &startIndexList) {
 ...
 */
size_t MonotoneChainIndexer::findChainEnd(const CoordinateSequence *pts, std::size_t start) {
