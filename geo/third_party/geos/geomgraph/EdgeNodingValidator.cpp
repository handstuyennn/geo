...
std::vector<SegmentString *> &EdgeNodingValidator::toSegmentStrings(std::vector<Edge *> &edges) {
...
EdgeNodingValidator::~EdgeNodingValidator() {
	for (SegmentString::NonConstVect::iterator i = segStr.begin(), e = segStr.end(); i != e; ++i) {
		delete *i;
	}
