...
private:
	...
	public:
		AccumulatingVisitor(std::vector<KdNode *> &p_nodeList) : nodeList(p_nodeList) {};
		void visit(KdNode *node) override {
...
public:
	...
	KdTree() : root(nullptr), numberOfNodes(0), tolerance(0.0) {};

	KdTree(double p_tolerance) : root(nullptr), numberOfNodes(0), tolerance(p_tolerance) {};
