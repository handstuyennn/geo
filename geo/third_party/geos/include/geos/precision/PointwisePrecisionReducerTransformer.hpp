...
private:
	...
	std::vector<geom::Coordinate> reducePointwise(const geom::CoordinateSequence *coordinates);

public:
	PointwisePrecisionReducerTransformer(const geom::PrecisionModel &p_targetPM) : targetPM(p_targetPM) {};
