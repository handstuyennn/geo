...
#include <geos/noding/SegmentNode.hpp> // for composition
#include <iostream>
#include <memory>
#include <set>
#include <vector>
...
private:
	...
	static bool findCollapseIndex(const SegmentNode &ei0, const SegmentNode &ei1, size_t &collapsedVertexIndex);

	void addEdgeCoordinates(const SegmentNode *ei0, const SegmentNode *ei1,
	                        std::vector<geom::Coordinate> &coordList) const;
