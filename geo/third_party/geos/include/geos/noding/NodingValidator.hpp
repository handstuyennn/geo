...
private:
	...
	void checkInteriorIntersections(const SegmentString &e0, std::size_t segIndex0, const SegmentString &e1,
	 ...
	 */
	bool hasInteriorIntersection(const algorithm::LineIntersector &aLi, const geom::Coordinate &p0,
...
public:
	NodingValidator(const std::vector<SegmentString *> &newSegStrings) : segStrings(newSegStrings) {
	}
