...
#include <geos/geom/PrecisionModel.hpp> // for inlines (should drop)
...
private:
	 ...
	 */
	void processNearVertex(SegmentString *srcSS, std::size_t srcIndex, const geom::Coordinate &p, SegmentString *ss,
	                       std::size_t segIndex, const geom::Coordinate &p0, const geom::Coordinate &p1);
