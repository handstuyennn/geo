...
public:
	PolygonRingSelfNode(const CoordinateXY &p_nodePt, const CoordinateXY *p_e00, const CoordinateXY *p_e01,
	                    const CoordinateXY *p_e10, const CoordinateXY *p_e11)
	    : nodePt(p_nodePt), e00(p_e00), e01(p_e01), e10(p_e10), e11(p_e11) {
	}
