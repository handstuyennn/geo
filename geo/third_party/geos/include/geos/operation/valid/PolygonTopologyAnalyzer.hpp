...
private:
	...
	static const CoordinateXY &findNonEqualVertex(const LinearRing *ring, const CoordinateXY &p);
	...
	static const CoordinateXY &findRingVertexPrev(const CoordinateSequence *ringPts, std::size_t index,
	                                              const CoordinateXY &node);

	static const CoordinateXY &findRingVertexNext(const CoordinateSequence *ringPts, std::size_t index,
	                                              const CoordinateXY &node);
...
public:
	 ...
	 */
	static bool isRingNested(const LinearRing *test, const LinearRing *target);
