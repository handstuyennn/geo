...
#include <geos/algorithm/LineIntersector.hpp> // for RelateComputer composition
#include <geos/algorithm/PointLocator.hpp>    // for RelateComputer composition
#include <geos/export.hpp>
#include <geos/geom/Coordinate.hpp> // for RelateComputer composition
#include <geos/geom/IntersectionMatrix.hpp>
#include <geos/geomgraph/NodeMap.hpp> // for RelateComputer composition
#include <memory>
#include <vector>
...
private:
	...
	void computeProperIntersectionIM(geomgraph::index::SegmentIntersector *intersector, geom::IntersectionMatrix *imX);
	 ...
	 */
	static int getBoundaryDim(const geom::Geometry &geom, const algorithm::BoundaryNodeRule &boundaryNodeRule);
	 ...
	 */
	void labelIsolatedEdge(geomgraph::Edge *e, uint8_t targetIndex, const geom::Geometry *target);

	/**
	 * If the Geometries are disjoint, we need to enter their dimension and
	 * boundary dimension in the Ext rows in the IM
	 */
	void computeDisjointIM(geom::IntersectionMatrix *imX, const algorithm::BoundaryNodeRule &boundaryNodeRule);
