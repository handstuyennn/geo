...
#include <cassert>
#include <geos/geom/Coordinate.hpp>              // for inlines
#include <geos/geom/CoordinateArraySequence.hpp> // for composition
...
public:
	OffsetSegmentString()
	    : ptList(new geom::CoordinateArraySequence()), precisionModel(nullptr), minimumVertexDistance(0.0) {
	}
