...
#include <geos/operation/overlayng/EdgeSourceInfo.hpp>
#include <geos/operation/overlayng/InputGeometry.hpp>
#include <geos/operation/overlayng/LineLimiter.hpp>
...
public:
	...
	EdgeNodingBuilder(const PrecisionModel *p_pm, Noder *p_customNoder)
	    : pm(p_pm), inputEdges(new std::vector<SegmentString *>), customNoder(p_customNoder), hasEdges {{false, false}},
	      clipEnv(nullptr), intAdder(lineInt) {};
