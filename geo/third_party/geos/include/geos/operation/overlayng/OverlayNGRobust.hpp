...
#include <geos/operation/union/UnionStrategy.hpp>
...
private:
	...
	static std::unique_ptr<Geometry> overlaySnapping(const Geometry *geom0, const Geometry *geom1, int opCode,
	                                                 double snapTol);

	static std::unique_ptr<Geometry> overlaySnapBoth(const Geometry *geom0, const Geometry *geom1, int opCode,
	                                                 double snapTol);

	static std::unique_ptr<Geometry> overlaySnapTol(const Geometry *geom0, const Geometry *geom1, int opCode,
	                                                double snapTol);
	 ...
	 */
	static std::unique_ptr<Geometry> overlaySR(const Geometry *geom0, const Geometry *geom1, int opCode);
	 ...
	 */
	static std::unique_ptr<Geometry> snapSelf(const Geometry *geom, double snapTol);
...
public:
	...
	static std::unique_ptr<geom::Geometry> Union(const geom::Geometry *a);
