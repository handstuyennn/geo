...
public:
	 ...
	 */
	Label(geom::Location onLoc) : elt {TopologyLocation(onLoc), TopologyLocation(onLoc)} {};
	...
	/// Copy ctor
	Label(const Label &l) : elt {TopologyLocation(l.elt[0]), TopologyLocation(l.elt[1])} {};
	 ...
	 */
	Label() : elt {TopologyLocation(geom::Location::NONE), TopologyLocation(geom::Location::NONE)} {};
