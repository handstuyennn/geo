...
public:
	...
	void computeIntersectsForChain(std::size_t chainIndex0, const MonotoneChainEdge &mce, std::size_t chainIndex1,
...
private:
	void computeIntersectsForChain(std::size_t start0, std::size_t end0, const MonotoneChainEdge &mce,
	                               std::size_t start1, std::size_t end1, SegmentIntersector &ei);

	bool overlaps(std::size_t start0, std::size_t end0, const MonotoneChainEdge &mce, std::size_t start1,
	              std::size_t end1);
};
