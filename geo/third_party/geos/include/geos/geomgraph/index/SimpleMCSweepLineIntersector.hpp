...
#include <geos/geomgraph/index/EdgeSetIntersector.hpp> // for inheritance
...
public:
	...
	void computeIntersections(std::vector<Edge *> *edges0, std::vector<Edge *> *edges1,
...
private:
	...
	void processOverlaps(std::size_t start, std::size_t end, SweepLineEvent *ev0, SegmentIntersector *si);
};
