...
public:
	...
	explicit LineIntersector(const geom::PrecisionModel *initialPrecisionModel = nullptr)
	    : precisionModel(initialPrecisionModel), result(0), inputLines(), isProperVar(false) {
	}
	...
	///
	static double computeEdgeDistance(const geom::Coordinate &p, const geom::Coordinate &p0,
	...
	void computeIntersection(const geom::Coordinate &p1, const geom::Coordinate &p2, const geom::Coordinate &p3,
	                         const geom::Coordinate &p4);

	/// Same as above but doesn't compute intersection point. Faster.
	static bool hasIntersection(const geom::CoordinateXY &p, const geom::CoordinateXY &p1,
...
private:
	 ...
	 */
	static geom::Coordinate nearestEndpoint(const geom::Coordinate &p1, const geom::Coordinate &p2,
	...
	uint8_t computeIntersect(const geom::Coordinate &p1, const geom::Coordinate &p2, const geom::Coordinate &q1,
	 ...
	 */
	geom::Coordinate intersection(const geom::Coordinate &p1, const geom::Coordinate &p2, const geom::Coordinate &q1,
	...
	static double zGetOrInterpolate(const geom::Coordinate &p, const geom::Coordinate &p1, const geom::Coordinate &p2) {
		double z = p.z;
		if (!std::isnan(z))
			return z;
	...
	static geom::Coordinate zGetOrInterpolateCopy(const geom::Coordinate &p, const geom::Coordinate &p1,
	...
	static double zInterpolate(const geom::Coordinate &p, const geom::Coordinate &p1, const geom::Coordinate &p2,
	                           const geom::Coordinate &q1, const geom::Coordinate &q2);
};
