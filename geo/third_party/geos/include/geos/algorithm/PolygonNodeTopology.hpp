...
public:
	 ...
	 */
	static bool isCrossing(const CoordinateXY *nodePt, const CoordinateXY *a0, const CoordinateXY *a1,
	 ...
	 */
	static bool isInteriorSegment(const CoordinateXY *nodePt, const CoordinateXY *a0, const CoordinateXY *a1,
...
private:
	 ...
	 */
	static bool isBetween(const CoordinateXY *origin, const CoordinateXY *p, const CoordinateXY *e0,
