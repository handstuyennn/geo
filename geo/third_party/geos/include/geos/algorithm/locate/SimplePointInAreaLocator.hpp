...
#include <geos/algorithm/locate/PointOnGeometryLocator.hpp> // inherited
...
public:
	...
	SimplePointInAreaLocator(const geom::Geometry *p_g) : g(p_g) {
	}
...
private:
	static geom::Location locateInGeometry(const geom::CoordinateXY &p, const geom::Geometry *geom);
