...
#include <geos/geom/Coordinate.hpp>         // destructor visibility for vector
#include <geos/geom/CoordinateSequence.hpp> // destructor visibility for unique_ptr
#include <geos/geom/Geometry.hpp>           // destructor visibility for unique_ptr
