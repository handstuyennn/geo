...
private:
	...
	std::unique_ptr<Polygon> editPolygon(const Polygon *polygon, GeometryEditorOperation *operation);

	std::unique_ptr<GeometryCollection> editGeometryCollection(const GeometryCollection *collection,
