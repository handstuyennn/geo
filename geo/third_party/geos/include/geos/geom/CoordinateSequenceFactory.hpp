...
public:
	 ...
	 */
	virtual std::unique_ptr<CoordinateSequence> create(std::vector<Coordinate> *coordinates,
	...
	virtual std::unique_ptr<CoordinateSequence> create(std::vector<CoordinateXY> &&coordinates,
	                                                   std::size_t dimension = 0) const = 0;
