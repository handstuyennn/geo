...
/*public*/
std::vector<SegmentString *> *SnapRoundingNoder::getNodedSubstrings() const {
...
/*public*/
void SnapRoundingNoder::computeNodes(std::vector<SegmentString *> *inputSegStrings) {
	snapRound(*inputSegStrings, snappedResult);
	return;
}

/*private*/
void SnapRoundingNoder::snapRound(std::vector<SegmentString *> &inputSegStrings,
...
/*private*/
void SnapRoundingNoder::addIntersectionPixels(std::vector<SegmentString *> &segStrings) {
...
/*private void*/
void SnapRoundingNoder::addVertexPixels(std::vector<SegmentString *> &segStrings) {
...
/*private*/
std::vector<Coordinate> SnapRoundingNoder::round(const std::vector<Coordinate> &pts) const {
...
/*private*/
void SnapRoundingNoder::computeSnaps(const std::vector<SegmentString *> &segStrings,
 ...
 */
/*private*/
NodedSegmentString *SnapRoundingNoder::computeSegmentSnaps(NodedSegmentString *ss) {
	/**
 ...
 */
/*private*/
void SnapRoundingNoder::snapSegment(Coordinate &p0, Coordinate &p1, NodedSegmentString *ss, std::size_t segIndex) {
	...
	struct SnapRoundingVisitor : KdNodeVisitor {
		...
		SnapRoundingVisitor(const Coordinate &pp0, const Coordinate &pp1, NodedSegmentString *pss,
		                    std::size_t psegIndex)
...
/*private*/
void SnapRoundingNoder::addVertexNodeSnaps(NodedSegmentString *ss) {
...
void SnapRoundingNoder::snapVertexNode(const Coordinate &p0, NodedSegmentString *ss, std::size_t segIndex) {
