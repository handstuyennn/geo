...
/* public (override) */
void NodingIntersectionFinder::processIntersections(SegmentString *e0, std::size_t segIndex0, SegmentString *e1,
	...
	bool isInteriorVertexInt =
	    (!isAdjacentSegment) && isInteriorVertexIntersection(p00, p01, p10, p11, isEnd00, isEnd01, isEnd10, isEnd11);
