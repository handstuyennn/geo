...
/*private*/
bool IntersectionAdder::isTrivialIntersection(const SegmentString *e0, std::size_t segIndex0, const SegmentString *e1,
...
/*public*/
void IntersectionAdder::processIntersections(SegmentString *e0, std::size_t segIndex0, SegmentString *e1,
                                             std::size_t segIndex1) {
